...
//	Version:  1.04 : added some functions
//
...
// 	ADDED blinker(), flipScreen() by Aniket on 8/10/2021
//
...
void LCD_SharpBoosterPack_SPI::flipScreen()
{
	if(_orientation = 0)
		setOrientation(2);
...
void LCD_SharpBoosterPack_SPI::blinker()
{
