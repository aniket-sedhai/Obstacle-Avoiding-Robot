...
class LCD_SharpBoosterPack_SPI : public Print
{
  public:
    ...
    /// @endcode
    ///
    LCD_SharpBoosterPack_SPI(uint8_t model = SHARP_128);
    ...
    /// @endcode
    ///
    LCD_SharpBoosterPack_SPI(uint8_t pinChipSelect, uint8_t pinDISP, uint8_t pinVCC, uint8_t model = SHARP_128);
    LCD_SharpBoosterPack_SPI(uint8_t pinChipSelect, uint8_t pinDISP, uint8_t pinVCC, bool autoVCOM, uint8_t model = SHARP_128);
